            ...
            <div className="px-8 flex w-full h-24">
                <div className="flex flex-grow h-full">
                    <div className="pr-4 flex flex-wrap content-center flex">
                        <Link to="/" className="block m-auto">
                            <p className="text-lg text-gray-900 font-semibold m-auto h-full">LW</p>
                        </Link>
                    </div>
                    <div className="px-4 flex flex-wrap content-center">
                        <Link to="/about" className="block m-auto">
                            <p className="text-lg text-gray-500 font-normal">About</p>
                        </Link>
                    </div>
                    <div className="px-4 flex flex-wrap content-center">
                        <Link to="/contact" className="block m-auto">
                ...
                <div className="flex flex-grow flex-row-reverse">
                    <div className="flex flex-wrap content-center">
                        <a href="https://github.com/Lewis1000" target="_blank" rel="noreferrer" className="block m-auto">
                            <div className="rounded-full p-2 bg-gray-900">
                                <svg height="28px" viewBox="0 0 256 249" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" fill="#fff">
